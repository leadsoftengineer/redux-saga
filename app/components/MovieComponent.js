...
export default class MovieComponent extends Component {
    ...
    render() {
        return (
            <View style={{ flex: 1, marginTop: Platform.OS === 'ios' ? 34 : 0, backgroundColor: 'yellow' }}>
                <Text style={{ margin: 10, fontWeight: 'bold', color: 'white', backgroundColor: 'silver', fontSize: 20 }}>
                    REDUX-SAGA - MOVIES
                </Text>
                ...
                <View style={{ height: 100, margin: 10 }}>
                    <TextInput style={{ flex: 1, margin: 5, padding: 10, borderColor: 'gray', borderWidth: 1, backgroundColor: 'white' }}
                        onChangeText={(text) => this.setState({ movieName: text })}
                        value={this.state.movieName}
                        placeholder='Enter new movie name'
                    />
                    <TextInput style={{ flex: 1, margin: 5, padding: 10, borderColor: 'gray', borderWidth: 1, width: 120, backgroundColor: 'white' }}
                ...
                <View style={{ height: 70, flexDirection: 'row' }}>
                    <Button
                        containerStyle={{ padding: 10, margin: 10, width: 150, height: 45, borderRadius: 10, backgroundColor: 'silver' }}
